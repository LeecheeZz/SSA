...
class Configuration:
 ...
 # ---------------------------------------------------------------------------------------------------------------
        ...
        parser.add_argument('--ckpt_path',
                            default='/home/imt3090/huangshuheng/mycode/DAC/checkpoints/sues-200/convnext_base.fb_in22k_ft_in1k_384/0122150455/weights_e1_0.9503.pth',
        ...
        parser.add_argument('--weight_nckl', default=0.5, type=float)
